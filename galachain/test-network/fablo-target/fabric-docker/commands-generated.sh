...
installChannels() {
  ...
  docker exec -i cli.curator.local bash -c "source scripts/channel_fns.sh; createChannelAndJoinTls 'product-channel' 'CuratorOrg' 'peer0.curator.local:7041' 'crypto/users/Admin@curator.local/msp' 'crypto/users/Admin@curator.local/tls' 'crypto-orderer/tlsca.orderer.local-cert.pem' 'orderer0.group1.orderer.local:7030';"

  printItalics "Joining 'product-channel' on  PartnerOrg1/peer0" "U1F638"
  docker exec -i cli.partner1.local bash -c "source scripts/channel_fns.sh; fetchChannelAndJoinTls 'product-channel' 'PartnerOrg1' 'peer0.partner1.local:7061' 'crypto/users/Admin@partner1.local/msp' 'crypto/users/Admin@partner1.local/tls' 'crypto-orderer/tlsca.orderer.local-cert.pem' 'orderer0.group1.orderer.local:7030';"
}
...
installChaincodes() {
  if [ -n "$(ls "$CHAINCODES_BASE_DIR/..")" ]; then
    ...
    chaincodeInstall "cli.curator.local" "peer0.curator.local:7041" "basic-product" "$version" "crypto-orderer/tlsca.orderer.local-cert.pem"
    chaincodeApprove "cli.curator.local" "peer0.curator.local:7041" "product-channel" "basic-product" "$version" "orderer0.group1.orderer.local:7030" "" "false" "crypto-orderer/tlsca.orderer.local-cert.pem" ""
    printHeadline "Installing 'basic-product' for PartnerOrg1" "U1F60E"
    chaincodeInstall "cli.partner1.local" "peer0.partner1.local:7061" "basic-product" "$version" "crypto-orderer/tlsca.orderer.local-cert.pem"
    chaincodeApprove "cli.partner1.local" "peer0.partner1.local:7061" "product-channel" "basic-product" "$version" "orderer0.group1.orderer.local:7030" "" "false" "crypto-orderer/tlsca.orderer.local-cert.pem" ""
    printItalics "Committing chaincode 'basic-product' on channel 'product-channel' as 'CuratorOrg'" "U1F618"
    chaincodeCommit "cli.curator.local" "peer0.curator.local:7041" "product-channel" "basic-product" "$version" "orderer0.group1.orderer.local:7030" "" "false" "crypto-orderer/tlsca.orderer.local-cert.pem" "peer0.curator.local:7041,peer0.partner1.local:7061" "crypto-peer/peer0.curator.local/tls/ca.crt,crypto-peer/peer0.partner1.local/tls/ca.crt" ""
  else
...
notifyOrgsAboutChannels() {
  ...
  notifyOrgAboutNewChannelTls "product-channel" "CuratorOrg" "cli.curator.local" "peer0.curator.local" "orderer0.group1.orderer.local:7030" "crypto-orderer/tlsca.orderer.local-cert.pem"
  notifyOrgAboutNewChannelTls "product-channel" "PartnerOrg1" "cli.partner1.local" "peer0.partner1.local" "orderer0.group1.orderer.local:7030" "crypto-orderer/tlsca.orderer.local-cert.pem"
